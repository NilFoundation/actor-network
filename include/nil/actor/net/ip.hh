...
namespace nil {
    namespace actor {
        ...
        namespace net {
            ...
            static inline bool is_unspecified(ipv4_address addr) noexcept {
                return addr.ip == 0;
            }
...
namespace std {
    ...
    template<>
    struct hash<nil::actor::net::ipv4_address> {
        size_t operator()(nil::actor::net::ipv4_address a) const {
            return a.ip;
        }
    };

    template<>
    struct hash<nil::actor::net::ipv6_address> {
        size_t operator()(const nil::actor::net::ipv6_address &) const;
    };
    ...
    namespace actor {
        ...
        namespace net {
            ...
            struct ipv4_traits {
                ...
                static void udp_pseudo_header_checksum(checksummer &csum, ipv4_address src, ipv4_address dst,
                                                       uint16_t len) {
            ...
            struct ipv4_frag_id {
                ...
                bool operator==(const ipv4_frag_id &x) const {
                    return src_ip == x.src_ip && dst_ip == x.dst_ip && identification == x.identification &&
                           protocol == x.protocol;
                }
            };

            struct ipv4_frag_id::hash : private std::hash<ipv4_address>,
                                        private std::hash<uint16_t>,
                ...
                size_t operator()(const ipv4_frag_id &id) const noexcept {
                    ...
                    return h1::operator()(id.src_ip) ^ h1::operator()(id.dst_ip) ^ h2::operator()(id.identification) ^
            ...
            struct l4connid<InetTraits>::connid_hash : private std::hash<ipaddr>, private std::hash<uint16_t> {
                size_t operator()(const l4connid<InetTraits> &id) const noexcept {
                    ...
                    using h2 = std::hash<uint16_t>;
                    return h1::operator()(id.local_ip) ^ h1::operator()(id.foreign_ip) ^ h2::operator()(id.local_port) ^
